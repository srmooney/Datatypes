    ...
    Namespace Vimeo
        Public Class DataType
            ...
            Public Overrides ReadOnly Property Id As Guid
                Get
                    Return New Guid("a3dbaf24-67dc-4167-81ee-c43854840c8b")
                End Get
            End Property
        ...
        Public Class DataEditor
            ...
            Protected Overrides Sub OnInit(e As EventArgs)
                ...
                Me.Controls.Add(New LiteralControl("<br />(i.e. https://vimeo.com/116289933)"))
        ...
        Public Class Data
            ...
            Sub New(url As String)
                ...
                Dim fullUrl As String = ("http://vimeo.com/api/oembed.json?url=" & url)
