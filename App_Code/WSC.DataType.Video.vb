    ...
    Namespace Video
        Public Class Datatype
            ...
            Public Overrides ReadOnly Property Id As Guid
                Get
                    Return New Guid("569cfe78-84bc-4c9f-90cc-4151951c5122")
                End Get
            End Property
        ...
        Public Class DataEditor
            ...
            Protected Overrides Sub OnInit(e As EventArgs)
                ...
                Me.Controls.Add(New LiteralControl("<br /><small>https://www.youtube.com/watch?v=XXXXXXXXXXX<br />https://vimeo.com/XXXXXXXXX</small>"))
        ...
        Public Class Data
            ...
            Sub New(url As String)
                ...
                Dim endPoint = String.Empty
                If url.Contains("youtube") Then
                    endPoint = ("http://www.youtube.com/oembed?format=json&url=" & url)
                End If
                If url.Contains("vimeo") Then
                    endPoint = ("http://vimeo.com/api/oembed.json?url=" & url)
                End If
                
                If String.IsNullOrEmpty(endPoint) Then Exit Sub

                Dim wc As New Net.WebClient()
                Try
                    Dim json As String = wc.DownloadString(endPoint)
